...
from difference_service import http_auth, ldap_auth, tenant_access
...
def test_identity_from_claims_refuses_a_foreign_tenant():
    ...
    from difference_service import jwt_verify
    claims = _claims({"alpha": ["users"]})
...
def test_bridge_verifier_refuses_a_foreign_tenant(monkeypatch):
    ...
    from difference_service import bridge_auth, token_revocation
